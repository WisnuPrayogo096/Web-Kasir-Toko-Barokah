...
?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <b><p class="modal-title" id="edit-profil<?= $adm['id'] ?>" style="text-align: center; font-size: 18px;">Edit Data Admin <?= $key['nama'];?></p></b>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="<?= $key['level'];?>" id="exampleInputEmail1" name="level" aria-describedby="emailHelp" placeholder="Masukkan level" readonly>
