...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="form-group">
    ...
    <input type="text" autofocus="" class="form-control" id="exampleInputEmail1" name="username" aria-describedby="emailHelp" required>
    ...
    <input type="password" class="form-control" id="exampleInputEmail1" name="confirmPassword" aria-describedby="emailHelp" required>
    ...
    <div>
      ...
      <b class="font-weight-bold h6">**Foto boleh kosong</b>
    </div>
  </div>
...
<script>
    function validatePassword() {
        ...
        if (password !== confirmPassword) {
            document.getElementById("passwordMatchError").innerHTML = "Password tidak sesuai!";
            return false;
        } else {
