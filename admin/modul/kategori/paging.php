...
<tr>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <b><p class="modal-title" id="hapus-kat<?= $pro['id'] ?>" style="text-align: center; font-size: 18px;">Apakah anda yakin menghapus ini?</p></b>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="<?= $pro['kategori'];?>" id="exampleInputEmail1" name="kategori" aria-describedby="emailHelp" required>
    
  </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="edit" class="btn btn-primary" id="saveButton">Save changes</button>
      </div>
        </form>
                </div>
              </div>
