...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <b><p class="modal-title" id="exampleModalLongTitle" style="text-align: center; font-size: 18px;">Tambah produk</p></b>
  ...
  <div class="form-group">
    <label>Barcode dengan pemisah ,</label>
    <input type="text" class="form-control" id="exampleInputEmail1" name="barcode[]" aria-describedby="emailHelp" multiple>
</div>
   ...
   <select name="kategori" class="form-control">
    ...
    <div class="form-group">
    <label>Stok</label>
    <input type="text" class="form-control" id="exampleInputEmail1" name="stok" aria-describedby="emailHelp" readonly="" value="0">
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  hargaInput.addEventListener("input", function() {
    saveButton.disabled = hargaInput.value.trim() === "";
  });
});
</script>
