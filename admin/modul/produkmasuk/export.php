  ...
  Kembali
			...
			<h4>(Inventory)</h4>
                ...
                <tbody>     
                    <?php 
                     $i = 1;
                     include 'pagingkhususexport.php';
  ...
  $(document).ready(function() {
        ...
        buttons: [
            ...
            },
            {
                ...
                customize: function(win) {
                    ...
                    $(win.document.body).find('h1').text('Laporan Produk Masuk');
    ...
    function generateFilename() {
        ...
        var formattedDate = currentDate.getDate() + '-' + 
                           ...
                           currentDate.getMinutes() + '-' + 
                           currentDate.getSeconds();
        return 'Export Prod. Masuk_' + formattedDate; // Menggunakan tanggal dan jam sebagai nama file
    }
} );
