  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard Produk Masuk</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <a href="modul/produkmasuk/export.php"><button type="button" class="btn btn-primary" style="background-color: #006400; border-color: #006400;" >
            Export
          </button></a> 
