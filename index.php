    ...
    <!-- <nav class="navbar navbar-default navbar-fixed-top navbar-custom">
      <div class="container">
        <div class="navbar-header page-scroll">
          <a class="navbar-brand">WEB KYKA BEAUTY</a>
        </div>
      </div>
    </nav>   -->
    <nav class="navbar navbar-default navbar-fixed-top navbar-custom">
  <div class="container">
    <div class="navbar-header page-scroll">
      <a class="navbar-brand" href="#">
        <!-- <img src="web.png" alt="Logo" width="100"> -->
      </a>
    </div>
  </div>
</nav>
          ...
          <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h1 class="panel-title text-center" style="font-weight: bold;">LOGIN PAGE</h1>
              </div>
              <div class="panel-body">
                <form class="form" action="" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input class="btn btn-success" type="submit" name="daftar" value="Login">
                  </div>
                  <?php 
                  if (@$_POST['daftar']) {
                    $proses->login();
