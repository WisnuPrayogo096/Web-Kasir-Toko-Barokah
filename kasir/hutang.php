  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard Laporan Hutang</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
        	<div class="col-sm-12">
              ...
              <!-- <a href="modul/laporan/export.php"><button type="button" class="btn btn-primary" style="background-color: #006400; border-color: #006400;" >
            Export -->
          </button></a> 
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <b><p class="modal-title" id="exampleModalLongTitle" style="text-align: center; font-size: 18px;">Hapus Data Laporan</p></b>
      ...
      <div class="modal-body">
        <form action="" method="POST">
         ...
         <h3 style="font-size: 18px;">Apakah anda yakin ingin menghapus semua data laporan ?</h3>

      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="simpan" class="btn btn-primary">Delete All</button>
      </div>
        </form>
    </div>
  </div>
